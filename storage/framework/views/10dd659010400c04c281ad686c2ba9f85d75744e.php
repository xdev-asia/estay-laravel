<?php if($paginator->hasPages()): ?>
    <ul class="pagination">
        ...
        <?php else: ?>
            <li class="waves-effect pagination-icon"><a href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev"><i class="material-icons">chevron_left</i></a></li>
        <?php endif; ?>
        ...
        <?php $__currentLoopData = $elements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            ...
            <?php if(is_string($element)): ?>
                <li class="waves-effect"><a href="#!"><?php echo e($element); ?></a></li>
            <?php endif; ?>
        ...
        <?php if($paginator->hasMorePages()): ?>
            <li class="waves-effect pagination-icon"><a href="<?php echo e($paginator->nextPageUrl()); ?>" rel="next"><i class="material-icons">chevron_right</i></a></li>
        <?php else: ?>

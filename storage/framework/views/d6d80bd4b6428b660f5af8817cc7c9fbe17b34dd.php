...
<?php $__env->startSection('title'); ?>
    <title><?php echo e(get_string('languages') . ' - ' . get_setting('site_name', 'site')); ?></title>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
<?php $__env->startSection('page_title'); ?>
    <h3 class="page-title mbot10"><?php echo e(get_string('languages')); ?></h3>
<?php $__env->stopSection(); ?>
<div class="col l12 m12 s12 right right-align mbot10">
    <a href="#language-modal" data-toggle="modal" class="add-button btn waves-effect"> <?php echo e(get_string('add_language')); ?> <i class="material-icons small">add_circle</i></a>
    <a href="#language-list-modal" data-toggle="modal" class="btn waves-effect"> <?php echo e(get_string('languages_list')); ?></a>
</div>
<div class="col s12">
        ...
        <div class="table-responsive" style="position: relative;">
            <table class="table bordered striped">
                ...
                <tr>
                    ...
                    <th><?php echo e(get_string('language')); ?></th>
                    <th><?php echo e(get_string('code')); ?></th>
                    <th><?php echo e(get_string('icon')); ?></th>
                ...
                <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                    <tr>
                        <td class="lang_id">
                            <input type="checkbox" class="filled-in primary-color" id="<?php echo e($language->id); ?>" />
                            <label for="<?php echo e($language->id); ?>"></label>
                        </td>
                        <td class="lang_name"><?php echo e($language->language); ?></td>
                        <td class="lang_code"><?php echo e($language->code); ?></td>
                        <td class="lang_flag"><img src="<?php echo e($language->flag); ?>" class="img-responsive"/></td>
                        <td>
                            <div class="icon-options">
                                <a class="edit-button" data-toggle="modal" href="#language-modal" title="<?php echo e(get_string('edit_language')); ?>"><i class="small material-icons color-primary">mode_edit</i></a>
                                <a href="#" class="delete-button" data-id="<?php echo e($language->id); ?>" title="<?php echo e(get_string('delete_language')); ?>"><i class="small material-icons color-red">delete</i></a>
                                <a href="#" class="make-featured-button <?php echo e($language->default ? 'hidden': ''); ?>" data-id="<?php echo e($language->id); ?>" title="<?php echo e(get_string('make_default')); ?>"><i class="small material-icons color-primary">grade</i></a>
                                <a href="#" class="make-default-button <?php echo e($language->default ? '': 'hidden'); ?>" data-id="<?php echo e($language->id); ?>" title="<?php echo e(get_string('make_non_default')); ?>"><i class="small material-icons color-yellow">grade</i></a>
                            </div>
                        </td>
                    </tr>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <strong class="modal-title"><?php echo e(get_string('edit_language')); ?></strong>
                    </div>
                    <div class="modal-body">
                        <?php echo Form::open(['method' => 'post', 'url' => route('admin_language_update'), 'id' => 'create-update-form']); ?>

                            <?php echo e(Form::input('hidden', 'id', null, ['class' => 'hidden', 'id' => 'form_lang_id'])); ?>

                        <div class="row mbot0">
                            <div class="col s12">
                                <div class="form-group  <?php echo e($errors->has('language') ? 'has-error' : ''); ?>">
                                    <?php echo e(Form::text('language', null, ['required', 'class' => 'form-control', 'placeholder' => get_string('language')])); ?>

                                    <?php echo e(Form::label('language', get_string('language'))); ?>

                                    <?php if($errors->has('language')): ?>
                                        <span class="wrong-error">* <?php echo e($errors->first('language')); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col l4 s6">
                                <div class="form-group  <?php echo e($errors->has('code') ? 'has-error' : ''); ?>">
                                    <?php echo e(Form::text('code', null, ['required', 'class' => 'form-control', 'placeholder' => get_string('code')])); ?>

                                    <?php echo e(Form::label('code', get_string('code'))); ?>

                                    <?php if($errors->has('code')): ?>
                                        <span class="wrong-error">* <?php echo e($errors->first('code')); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col l4 s6">
                                <div class="form-group  <?php echo e($errors->has('flag') ? 'has-error' : ''); ?>">
                                    <?php echo e(Form::text('flag', null, ['class' => 'form-control', 'required', 'placeholder' => get_string('icon')])); ?>

                                    <?php echo e(Form::label('flag', get_string('icon'))); ?>

                                    <?php if($errors->has('flag')): ?>
                                        <span class="wrong-error">* <?php echo e($errors->first('flag')); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" name="action" class="update-lang-form waves-effect btn btn-default"><?php echo e(get_string('update_language')); ?></button>
                    </div>
                    <?php echo Form::close(); ?>
    ...
    <div id="language-list-modal" class="modal not-summernote fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content" style="height: 400px; overflow-y: scroll;">
                <div class="modal-header">
                    <a href="#!" class="close" data-dismiss="modal" aria-label="Close"><i class="material-icons">clear</i></a>
                    <strong class="modal-title"><?php echo e(get_string('list_all_languages')); ?></strong>
                </div>
                <div class="modal-body">
            ...
            $('.delete-button').click(function(event){
                ...
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        if(result){
                            $.ajax({
                                url: '<?php echo e(url('/admin/settings/language/destroy')); ?>/'+id,
                                type: 'post',
                                data: {_token :token},
                                beforeSend: function(){
            ...
            $('.make-featured-button').click(function(event){
                ...
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        if(result){
                            $.ajax({
                                url: '<?php echo e(url('/admin/settings/language/makeDefault')); ?>/'+id,
                                type: 'post',
                                data: {_token :token},
                                success:function(msg) {
                                    location.reload();

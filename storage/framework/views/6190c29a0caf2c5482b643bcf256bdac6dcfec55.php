<?php $__env->startSection('title', trans('installer_messages.admin.title')); ?>
...
<?php $__env->startSection('container'); ?>
    <form method="post" action="<?php echo e(route('LaravelInstaller::adminSave')); ?>" id="env-form">
    ...
    <script>
        $(document).ready(function(){
            $('.submit-form').click(function(e){
                ...
                $.easyAjax({
                    url: "<?php echo route('LaravelInstaller::adminSave'); ?>",
                    type: "post",
                    ...
                    success: function(data){
                        location.href  = '<?php echo e(url('install/final')); ?>';
                    }, error: function(data){

...
<?php $__env->startSection('title'); ?>
    <title><?php echo e($static_data['strings']['location'] . ' - ' . $location->contentload->location); ?></title>
    <meta name="title" content="<?php echo e($static_data['strings']['location'] . ' - ' . $location->contentload->location); ?>">
    <meta name="description" content="<?php echo e(strip_tags($location->contentload->description)); ?>">
    ...
    <meta property="og:title" content="<?php echo e($static_data['strings']['location'] . ' - ' . $location->contentload->location); ?>" />
    <meta property="og:image" content="<?php echo e(URL::asset('/assets/images/home/').'/'.$static_data['design_settings']['slider_background']); ?>" />
    <meta property="og:description" content="<?php echo e(strip_tags($location->contentload->description)); ?>">
...
<?php $__env->startSection('bg'); ?>
    <?php if($location->featured_image): ?>
        <?php echo e($location->featured_image); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row marginalized">
        <div class="col-sm-12">
            <h1 class="section-title-dark"><?php echo e($static_data['strings']['location'] . ' - ' . $location->contentload->location); ?></h1>
...
<?php $__env->startSection('footer'); ?>
    ...
    <input type="hidden" name="location_id" class="hidden location_id" value="<?php echo e($location->id); ?>"/>
    ...
    <script type="text/javascript">
        $('document').ready(function(){
            ...
            $('.load-more-properties').click(function(e){
                ...
                e.preventDefault();
                $.ajax({
                    url: '<?php echo e(url('location') .'/'. $location->id .'/properties?page='); ?>' + page_property,
                    beforeSend: function(){
            ...
            $('.load-more-services').click(function(e){
                ...
                e.preventDefault();
                $.ajax({
                    url: '<?php echo e(url('location') .'/'. $location->id .'/services?page='); ?>' + page_service,
                    beforeSend: function(){
                        $this.hide();
                        ajax_loader.show();
                    }

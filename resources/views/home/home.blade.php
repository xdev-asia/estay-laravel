  ...
  <footer>
    <section class="section bg-light footer-top-menu">
      <div class="container">
        <div class="row">
            <div class="col">
              <h5>{{ $static_data['strings']['opt_footer_menu1_head'] }}</h5>
              <p class="mb-0">
            ...
            <div class="col">
              <h5>{{ $static_data['strings']['opt_footer_menu2_head'] }}</h5>
              <p class="mb-0">
                  <a href="{{$static_data['design_settings']['footer_menu2_link1']}}">{{$static_data['strings']['opt_footer_menu2_text1']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu2_link2']}}">{{$static_data['strings']['opt_footer_menu2_text2']}}</a>
              </p>
              <p class="mb-0">
                  <a href="{{$static_data['design_settings']['footer_menu2_link3']}}">{{$static_data['strings']['opt_footer_menu2_text3']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu2_link4']}}">{{$static_data['strings']['opt_footer_menu2_text4']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu2_link5']}}">{{$static_data['strings']['opt_footer_menu2_text5']}}</a>
              </p>
            </div>
             {{-- <div class="col">
              <h5>{{ $static_data['strings']['opt_footer_menu3_head'] }}</h5>
              <p class="mb-0">
                  <a href="{{$static_data['design_settings']['footer_menu3_link1']}}">{{$static_data['strings']['opt_footer_menu3_text1']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu3_link2']}}">{{$static_data['strings']['opt_footer_menu3_text2']}}</a>
              </p>
              <p class="mb-0">
                  <a href="{{$static_data['design_settings']['footer_menu3_link3']}}">{{$static_data['strings']['opt_footer_menu3_text3']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu3_link4']}}">{{$static_data['strings']['opt_footer_menu3_text4']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu3_link5']}}">{{$static_data['strings']['opt_footer_menu3_text5']}}</a>
              </p>
            </div>
           <div class="col">
              <h5>{{ $static_data['strings']['opt_footer_menu4_head'] }}</h5>
              <p class="mb-0">
                  <a href="{{$static_data['design_settings']['footer_menu4_link1']}}">{{$static_data['strings']['opt_footer_menu4_text1']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu4_link2']}}">{{$static_data['strings']['opt_footer_menu4_text2']}}</a>
              </p>
              <p class="mb-0">
                  <a href="{{$static_data['design_settings']['footer_menu4_link3']}}">{{$static_data['strings']['opt_footer_menu4_text3']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu4_link4']}}">{{$static_data['strings']['opt_footer_menu4_text4']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu4_link5']}}">{{$static_data['strings']['opt_footer_menu4_text5']}}</a>
              </p>
            </div>
           <div class="col">
              <h5>{{ $static_data['strings']['opt_footer_menu4_head'] }}</h5>
              <p class="mb-0">
                  <a href="{{$static_data['design_settings']['footer_menu5_link1']}}">{{$static_data['strings']['opt_footer_menu5_text1']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu5_link2']}}">{{$static_data['strings']['opt_footer_menu5_text2']}}</a>
              </p>
              <p class="mb-0">
                  <a href="{{$static_data['design_settings']['footer_menu5_link3']}}">{{$static_data['strings']['opt_footer_menu5_text3']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu5_link4']}}">{{$static_data['strings']['opt_footer_menu5_text4']}}</a>
              </p>
              <p class="mb-0">
                <a href="{{$static_data['design_settings']['footer_menu5_link5']}}">{{$static_data['strings']['opt_footer_menu5_text5']}}</a>
              </p>
            </div>  --}}
        </div>
      </div>

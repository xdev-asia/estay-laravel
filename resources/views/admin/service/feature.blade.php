...
<div id="feature-modal" class="modal not-summernote fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'post', 'url' => route('admin_service_feature_store')]) !!}
...
<div id="update-modal" class="modal not-summernote fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            {!! Form::open(['method' => 'post', 'url' => route('admin_service_feature_update')]) !!}
            <div class="modal-body">
                <div class="row mbot0">
...
<script>
    $(document).ready(function(){
        $('.delete-button').click(function(event){
            ...
            bootbox.confirm({
                ...
                callback: function (result) {
                    if(result){
                        $.ajax({
                            url: '{{ url('/admin/service/feature/destroy') }}/'+id,
                            type: 'post',
                            data: {_token :token},
        ...
        $('.edit-button').click(function(event){
            ...
            var token = $('[name=_token]').val();
            $.ajax({
                url: '{{ url('/admin/service/feature/getFeature') }}/'+id,
                type: 'get',
                data: {_token :token},
                success:function(msg) {
                    $('#feature_id').val(id);
